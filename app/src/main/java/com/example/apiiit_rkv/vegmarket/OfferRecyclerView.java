...
/**
 * Created by apiiit-rkv on 4/4/18.
 */
...
public class OfferRecyclerView extends RecyclerView.Adapter<OfferRecyclerView.ViewHolder> {
    ...
    List<ImageUploadInf> MainImageUploadInfoList;
    View view_one;
    FirebaseAuth auth;
    FirebaseUser user;
    ...
    public OfferRecyclerView(Context context, List<ImageUploadInf> TempList) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ImageUploadInf UploadInfo = MainImageUploadInfoList.get(position);
        ...
        holder.buy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final ImageUploadInf up=MainImageUploadInfoList.get(i);
