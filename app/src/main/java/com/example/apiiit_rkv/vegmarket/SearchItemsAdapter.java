...
public class SearchItemsAdapter extends RecyclerView.Adapter<SearchItemsAdapter.ViewHolder> {
    ...
    List<SearchItemsInfo> MainImageUploadInfoList;
    View view_one;
    FirebaseAuth auth;
    FirebaseUser user;
    ...
    public SearchItemsAdapter(Context context, List<SearchItemsInfo> TempList) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        SearchItemsInfo UploadInfo = MainImageUploadInfoList.get(position);
        ...
        String myyy=((SearchItems)mycontext).getmykey();
        boolean isFound = UploadInfo.getItemtitle().contains(myyy);
        ...
        holder.buy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final SearchItemsInfo up=MainImageUploadInfoList.get(i);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            showing=(LinearLayout)itemView.findViewById(R.id.showing);
